        ...
        <section>
            ...
            <div className="flex justify-center items-end">
                <div >
                    ...
                    <div>
                        <p className="text-[4.5rem] w-160 font-medium leading-25">Master Your
                            Freelance
                            <span className="text-[#2b8cee]"> Business</span> with
                            Ease</p>
                    </div>

                    <p className="text-[#94A3B8] w-120">
                        Track clients, invoices, and profits in one powerful dashboard <br />
                        designed for the modern freelancer.  Automate the boring <br /> stuff <br />
                        and focus on what you love.
                    </p>

                    <br />
                    <div className="flex gap-5">
                        <button className="flex justify-center items-center gap-2 text-[white] bg-[#2B8CEE] hover:bg-[#2B8CEE]/80 transition-all duration-300 w-fit h-15 px-5 rounded-xl">Start Free Trial <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.175 9H0V7H12.175L6.575 1.4L8 0L16 8L8 16L6.575 14.6L12.175 9Z" fill="white" />
                        </svg>
                        </button>

                        <button className="flex justify-center items-center gap-2 text-[white] bg-[#1e293b] hover:bg-[#1e293b]/80 w-fit h-15 px-5 rounded-xl">Watch Live Demo <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
