    ...
    return (
        <section className="py-15">
            ...
            <section className="flex justify-center items-start">
                <div >
                    ...
                    <div className="flex gap-5">
                        <Link to={"/onboarding"} className="flex justify-center items-center gap-2 text-[white] bg-accent hover:bg-accent/80 transition-all duration-300 w-fit h-15 px-5 rounded-xl">Start Free Trial <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-primary flex flex-col items-center">
                ...
                <h3 className="text-[4rem] pt-10">Everything you need to grow</h3>
                ...
                <div className="grid grid-rows-3 grid-cols-3 gap-8 pt-8">
                    {/* //card */}
