    ...
    return (
        <Fade className="py-15">
            ...
            <section className="flex flex-col justify-center items-center text-center" >
                ...
                <div>
                    <p className="text-[clamp(2.5rem,6vw,4.8rem)] px-5 max-w-250 font-medium md:leading-25">Master Your
                        Freelance
                ...
                <div>
                    ...
                    <p className="hidden md:flex justify-center items-center text-subtle font-medium gap-2"> <svg width="20" height="20" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg>No credit card required. 14-day free trial.</p>
                </div>
            </section>
            ...
            {/* cta */}
            <div className="bg-[#2b8cee] rounded-3xl flex flex-col items-center text-center py-25 md:px-45 justify-self-center shadow-md hover:shadow-lg">
